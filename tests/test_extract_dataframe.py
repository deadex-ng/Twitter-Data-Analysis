...
class TestTweetDfExtractor(unittest.TestCase):
    ...
    def test_find_sentiments(self):
        self.assertEqual(self.df.find_sentiments(self.df.find_full_text()), ([0.0, 0.13333333333333333, 0.3166666666666667, 0.16666666666666666, 0.3], [0.18888888888888888, 0.45555555555555555, 0.48333333333333334, 0.19722222222222224, 0.6199999999999999]))
